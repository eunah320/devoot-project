                ...
                >
                    <div class="flex flex-col items-center">
                        <div class="flex flex-row">
                            ...
                            <p>
                                <span class="text-body-bold">{{ notification.fromUser }}</span>
                                <span v-if="notification.followId" class="text-body"
                                    >님이 팔로우 요청을 보냈습니다.</span
                                >
                                <span v-else>님이 팔로우하기 시작했습니다.</span>
                            </p>
                        </div>
                        <button
                            v-if="notification.followId"
                            class="flex justify-center text-body-bold px-3 py-1 w-[13.25rem] h-[1.563rem] text-white bg-primary-500 rounded-md hover:bg-blue-600"
